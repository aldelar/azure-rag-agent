...
fields = [
    ...
    SimpleField(name="documentName", type=SearchFieldDataType.String, sortable=True, filterable=True, facetable=True),
    SimpleField(name="documentUrl", type=SearchFieldDataType.String),
    SimpleField(name="chunkIndex", type=SearchFieldDataType.String),
    SearchableField(name="chunkTitle", type=SearchFieldDataType.String),
    SearchableField(name="chunkContent", type=SearchFieldDataType.String),
    SearchField(name="chunkContentVector", type=SearchFieldDataType.Collection(SearchFieldDataType.Single), searchable=True, vector_search_dimensions=1536, vector_search_profile_name="myHnswProfile")
]
